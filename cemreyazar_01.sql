...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 18 Kas 2020, 10:46:40
...
(1, '2020-11-02 21:30:58', '9786055272296', 'MOMO', 2005, 'İstanbul', '303 s.', 'Türkçe'),
(2, '2020-11-02 21:52:53', '9789750739057', 'Şeker Portakalı', 2018, 'İstanbul', '527 s.', 'Türkçe'),
(3, '2020-11-02 21:57:05', '9786055127824', 'Küçük Prens', 2015, 'İstanbul', '79 s.', 'Türkçe'),
(4, '2020-11-02 22:00:39', '9786059604741', 'Çizgili Pijamalı Çocuk', 2017, 'İstanbul', '198 s.', 'Türkçe'),
(5, '2020-11-02 22:04:34', '9789750815546', 'Pal Sokağı Çocukları', 2013, 'İstanbul', '235 s.', 'Türkçe'),
(6, '2020-11-02 22:12:31', '9789750812989', 'Harry Potter ve Ölüm Yadigarları', 2014, 'İstanbul', '690 s.', 'Türkçe'),
(7, '2020-11-02 22:15:00', '9789750816475', 'Dede Korkut', 2019, 'İstanbul', '302 s.', 'Türkçe'),
(8, '2020-11-02 22:16:54', '9786051418971', 'Masal Masal İçinde', 2015, 'İstanbul', '157 s.', 'Türkçe'),
(9, '2020-11-02 22:19:46', '9786050922912', 'Sakız Sardunya', 2015, 'İstanbul', '151 s.', 'Türkçe'),
(10, '2020-11-02 22:23:42', '9789756093139', 'Şu hortumlu dünyada fil yalnız bir hayvandır', 2015, 'İstanbul', '161 s.', 'Türkçe');
...
--
ALTER TABLE `yayinevi`
  MODIFY `YayineviKayitNo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Yayınevi bilgisinin ana anahtarı', AUTO_INCREMENT=11;
