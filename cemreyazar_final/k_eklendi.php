<?php
    ...
    $sorgu = "INSERT INTO kitap (KAdi, ISBN, KBasimYili, KBasimYeri, KSayfaSayisi, KDil, YKayitNo, YayineviKayitNo, KAciklama)
            VALUES ('$KAdi', '$ISBN', '$KBasimYili', '$KBasimYeri', '$KSayfaSayisi', '$KDil', '$YKayitNo', '$YayineviKayitNo', '$KAciklama')";
